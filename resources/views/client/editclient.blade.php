...
@section('content')
     <div class="col-xs-12 effect-content"  style=" overflow: hidden;">
          ...
          @foreach($client as $myclient)
                <form method="POST" action="/client/update/{{$myclient->id}}"  id="clientupdateform">
                <section >
                  {{ csrf_field() }}
                        ...
                        <div class="col-xs-12 col-sm-6  animated "> <h6 style="color: #444;font-family: 'Cairo';"><span class="fa fa-user" style="padding: 0px 5px;color: #13c4a5"></span>  معلومات الاتصال الاساسية</h6>
                          ...
                          <div class="col-xs-10" style="padding: 20px 5px;">
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="name" class="form-control" value="{{ $myclient->name }}">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="taxid" class="form-control" value="{{ $myclient->taxid }}">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="startbalance" class="form-control" style="max-width: 40%;" value="{{ $myclient->startbalance }}">
                              </div>
                 ...
                 <select class="form-control select2 dealstatus" style="width: 100%;" name="send_not_period">  
                        ...
                        <div class="col-xs-12 col-sm-6  animated " style="min-height: 443px">
                          ...
                          <div class="col-xs-10" style="padding: 20px 5px;">
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="contacttype" class="form-control" value="{{ $myclient->contacttype }}">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="phone" class="form-control" value="{{ $myclient->phone }}">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="email" class="form-control" value="{{ $myclient->email }}">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="website" class="form-control" value="{{ $myclient->website }}">
                              </div>
                        ...
                        <div class="col-xs-12 col-sm-6  animated ">
                          ...
                          <div class="col-xs-10" style="padding: 20px 5px;">
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="facebook" class="form-control" value="{{ $myclient->facebook }}">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="twitter" class="form-control" value="{{ $myclient->twitter }}">
                              </div>
                            ...
                            جوجل بلس
                              ...
                              <div class="col-xs-9">
                                <input type="" name="google" class="form-control" value="{{ $myclient->google }}">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="linkedin" class="form-control" value="{{ $myclient->linkedin }}">
                              </div>
                  ...
                  <section class="content">
                    <div class="row" style="padding: 5px 4%">
                       <textarea style="box-shadow: none;border-radius: 0px;height: 200px;" class="form-control" name="details">{{ $myclient->name }}</textarea>
                    </div>
                  </section>
