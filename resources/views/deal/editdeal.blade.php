...
@section('content')
  ...
  @foreach($deal as $mydeal)
            <form action="/deal/update/{{$mydeal->id}} " method="POST"  >
    {{csrf_field()}}
        ...
        <div class="col-xs-6">
           ...
           <div class="col-xs-12" style="padding: 10px 5px;">
              ...
              <div class="col-xs-3">
                ...
                <input type="" name="mount" class="form-control" style="width: 100%;" value="{{ $mydeal->deal_mount }}">
              </div>
           ...
           <div class="col-xs-12" style="padding: 10px 5px;">
              ...
              <div class="col-xs-7">
                <input type="" name="for" class="form-control" style="width: 100%;"  value="{{ $mydeal->for }}">
              </div>
            </div>
           ...
           <div class="col-xs-12" style="padding: 10px 5px;">
              ...
              <div class="col-xs-7" style="padding: 7px 12px 0px 14px;">
                <div class="col-xs-12" style="margin-top: 10px;padding: 0px;">
                  <textarea style="border:1px solid #ced4da;border-radius: 0px;min-height: 210px;" class="form-control" placeholder="للعميل" id="note" name="detailsforclient">{{ $mydeal->deal_details_for_client }}</textarea>
                </div> 
              </div>
            </div>
            ...
            <div class="col-xs-12" style="padding: 10px 5px;">
              ...
              <div class="col-xs-7" style="padding: 7px 12px 0px 14px;">
                <div class="col-xs-12" style="margin-top: 10px;padding: 0px;">
                  <textarea style="border:1px solid #ced4da;border-radius: 0px;min-height: 210px;" class="form-control" placeholder="للموظف" id="note" name="detailsforemp">{{ $mydeal->deal_details_for_emp }}</textarea>
                </div> 
              </div>
            </div>
