                       ...
                       <div class="col-xs-12" style="padding: 40px 10px;">
                          ...
                          <div class=" col-md-4">
                                ...
                                <div class="col-xs-12">
                                  ...
                                  <div class="col-xs-7  text-right">
                                         {{\app\Http\Controllers\messageController::get_name_client_emp_by_id($message->message_receiver_id,$message->client_or_emp,'name')}}
                              ...
                              <div class=" col-md-8">
                                ...
                                <div class="col-xs-12">
                                  ...
                                  <div class="col-xs-9 text-right">
                                     <pre> {{ $message->message_content }}</pre>
                                  </div>
                                </div>
                            </div>  
