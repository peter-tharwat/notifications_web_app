...
@section('content')
     <div class="col-xs-12 effect-content"  style=" overflow: hidden;">
            ...
            <div class="panel" >
              ...
              <form method="post" action="/emp" id="createempform">
                {{ csrf_field() }}
                <section >
                    <header class="panel-heading text-right"  style="padding: 5px 6px;">
                        
                        <div class="col-xs-5" style="padding: 0px;">
                            <span class="hidden-sm" style="padding: 3px;display: inline-block;">اضافة موظف جديد</span>
                        </div>
                        <div class="col-xs-7" style="padding: 0px;direction: ltr!important;">
                            ...
                            <span style="padding: 2px 5px; direction: ltr!important;display: inline-block;float: left;" >
                              <span style="background: #13c4a5;color: #fff;border-radius: 0px;padding:1px 7px; ;cursor: pointer;float: left;" class="btn btn-success" onclick="$('#createempform').submit();" >
