<?php $__env->startSection('content'); ?>
     <div class="col-xs-12 effect-content"  style=" overflow: hidden;">
          ...
          <?php $__currentLoopData = $client; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $myclient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <form method="POST" action="/client/update/<?php echo e($myclient->id); ?>"  id="clientupdateform">
                <section >
                  <?php echo e(csrf_field()); ?>
                    ...
                    <header class="panel-heading text-right"  style="padding: 5px 6px;">
                        ...
                        <div class="col-xs-5" style="padding: 0px;">
                            <span class="hidden-sm" style="padding: 3px;display: inline-block;">تعديل عميل </span>
                        </div>
                        <div class="col-xs-7" style="padding: 0px;direction: ltr!important;">
                            ...
                            <a style="padding: 2px 5px; direction: ltr!important;display: inline-block;float: left;" >
                              <span style="background: #13c4a5;color: #fff;border-radius: 0px;padding:1px 7px; ;cursor: pointer;float: left;" class="btn btn-success" onclick="$('#clientupdateform').submit();"   >
                        ...
                        <div class="col-xs-12 col-sm-6  animated "> <h6 style="color: #444;font-family: 'Cairo';"><span class="fa fa-user" style="padding: 0px 5px;color: #13c4a5"></span>  معلومات الاتصال الاساسية</h6>
                          ...
                          <div class="col-xs-10" style="padding: 20px 5px;">
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="name" class="form-control" value="<?php echo e($myclient->name); ?>">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="taxid" class="form-control" value="<?php echo e($myclient->taxid); ?>">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="startbalance" class="form-control" style="max-width: 40%;" value="<?php echo e($myclient->startbalance); ?>">
                              </div>
                ...
                <div class="form-group">
                  <!-- <input class="form-control" placeholder="إلي :"> -->
                   ...
                   <div style="position: relative;padding: 5px;">
                    <input type="checkbox" name="send_not" style="width: 60px;height: 30px; position: absolute;z-index: 10;opacity: 0" id="send_not_id"
                     onchange="
                     if($(this).is(':checked'))
                     ...
                     " 
                   value="on" class="isagancy"  <?php if($myclient->send_not=='on')  echo "checked";?>
                     >
              ...
              <div class="col-xs-12" style="padding: 10px 5px;">
                ...
                <div class="col-xs-7" style="height: 30px;">
                  ...
                  <span  style="position: absolute;right: 55px; bottom: 0px; border-radius: 0px;padding: 2px 10px;font-size: 12px;font-weight: normal;outline: none;box-shadow: 0px;border:1px solid  #13c4a5;display: inline-block;background:  #13c4a5 " for="sms_tag" id="sms_tag">
                    ...
                    <?php if( strpos($myclient->send_not_methods  , 'sms')) echo "checked";?>
                    >
                  ...
                  <span  style="position: absolute;right: 120px; bottom: 0px; border-radius: 0px;padding: 2px 10px;font-size: 12px;font-weight: normal;outline: none;box-shadow: 0px;border:1px solid  #13c4a5;display: inline-block;background:  #13c4a5" id="whatsapp_tag" >
                    <input type="checkbox" name="send_not_methods[]" value="whatsapp" style="bottom: -2px;margin: 0px;position: relative;height: 20px;width: 20px;"  <?php if( strpos($myclient->send_not_methods  , 'whatsapp')) echo "checked";?>>
                  ...
                  <span  style="position: absolute;right: 191px; bottom: 0px; border-radius: 0px;padding: 2px 10px;font-size: 12px;font-weight: normal;outline: none;box-shadow: 0px;border:1px solid  #13c4a5;background:  #13c4a5" id="email_tag">
                    <input type="checkbox" name="send_not_methods[]" value="email" style="bottom: -2px;margin: 0px;position: relative;height: 20px;width: 20px;"  <?php if( strpos($myclient->send_not_methods  , 'email')) echo "checked";?>>
             ...
             <div class="col-xs-12" style="padding: 10px 5px;">
                ...
                <div class="col-xs-5">
                 <select class="form-control select2 dealstatus" style="width: 100%;" name="send_not_period">  
                  <option value="+ 1 days" <?php if($myclient->send_not_period=="+ 1 days")echo "selected"; ?>>يوم</option>
                  <option value="+ 2 days" <?php if($myclient->send_not_period=="+ 2 days")echo "selected"; ?>>يومين</option>
                  <option value="+ 3 days" <?php if($myclient->send_not_period=="+ 3 days")echo "selected"; ?>>3 ايام</option>
                  <option value="+ 7 days" <?php if($myclient->send_not_period=="+ 7 days")echo "selected"; ?>>اسبوع</option>
                  <option value="+ 14 days" <?php if($myclient->send_not_period=="+ 14 days")echo "selected"; ?>>اسبوعين</option>
                  <option value="+ 21 days" <?php if($myclient->send_not_period=="+ 21 days")echo "selected"; ?>>3 اسابيع</option>
                  <option value="+ 1 months" <?php if($myclient->send_not_period=="+ 1 months")echo "selected"; ?>>شهر</option>
                  <option value="+ 2 months" <?php if($myclient->send_not_period=="+ 2 months")echo "selected"; ?>>شهرين</option>
                  <option value="+ 3 months" <?php if($myclient->send_not_period=="+ 3 months")echo "selected"; ?>>3 اشهر</option>
                  </select>
                </div>
             </div>
                        ...
                        <div class="col-xs-12 col-sm-6  animated " style="min-height: 443px">
                          ...
                          <div class="col-xs-10" style="padding: 20px 5px;">
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="contacttype" class="form-control" value="<?php echo e($myclient->contacttype); ?>">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="phone" class="form-control" value="<?php echo e($myclient->phone); ?>">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="email" class="form-control" value="<?php echo e($myclient->email); ?>">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="website" class="form-control" value="<?php echo e($myclient->website); ?>">
                              </div>
                        ...
                        <div class="col-xs-12 col-sm-6  animated ">
                          ...
                          <div class="col-xs-10" style="padding: 20px 5px;">
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="facebook" class="form-control" value="<?php echo e($myclient->facebook); ?>">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="twitter" class="form-control" value="<?php echo e($myclient->twitter); ?>">
                              </div>
                            ...
                            جوجل بلس
                              ...
                              <div class="col-xs-9">
                                <input type="" name="google" class="form-control" value="<?php echo e($myclient->google); ?>">
                              </div>
                            ...
                            <div class="col-xs-12" style="padding: 6px;">
                              ...
                              <div class="col-xs-9">
                                <input type="" name="linkedin" class="form-control" value="<?php echo e($myclient->linkedin); ?>">
                              </div>
                  ...
                  <section class="content">
                    <div class="row" style="padding: 5px 4%">
                       <textarea style="box-shadow: none;border-radius: 0px;height: 200px;" class="form-control" name="details"><?php echo e($myclient->name); ?></textarea>
                    </div>
                  </section>
     ...
     <script type="text/javascript">
       ...
       setTimeout(function(){ 
          ...
          if(<?php if($myclient->send_not=='on')  echo "true";?>)
        {
           if($('#send_not_id').is(':checked'))
